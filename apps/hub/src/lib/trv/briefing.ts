...
export const BRIEFING_STEPS: BriefStep[] = [
  ...
  },
  {
    ...
    body: "Daily duty is intercepting hostile packets before they reach The Sentinel. One clean intercept on Defend or Mesh fulfills the watch. Then claim TRV. Missed days damage Sentinel health. Honeypot arms lures so inbound tricks file themselves.",
    icon: Brain,
    stops: [
