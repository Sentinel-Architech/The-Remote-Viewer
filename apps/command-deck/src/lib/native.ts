...
const STACK: { letter: string; name: string; line: string }[] = [
  ...
  { letter: "G", name: "GPU", line: "WebGL field. WebGPU hosts on-device specialists when the chip allows. Local weights only." },
  ...
  { letter: "Q", name: "Quality", line: "4K on a capable deck — 3840 by 2160. Phones stay native so every Wi-Fi screen stays playable." },
  { letter: "R", name: "Rapier", line: "Fixed 1/60. Solver follows the device. 4K raises the mesh. CCD only on God's Eye." },
