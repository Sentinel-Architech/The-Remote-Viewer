...
**Do not contradict:** `apps/web` and `apps/mobile` remain scaffolds. The live client is **`apps/hub`**. Solana `trv_governance` is still SCAFFOLD. Ed25519 addresses in the hub are not a mainnet program.
