...
The **live product client** is the Viewer Hub: [`apps/hub`](../apps/hub)  
Hosted: [the-remote-viewer.grok.me](https://the-remote-viewer.grok.me)

This `clients/` tree is the **older** PWA / Android / Wear / entitlement scaffold set. It is **not** the hub.

| Module | Upgrade focus | State |
|--------|---------------|--------|
| `../apps/hub/` | Hosted Viewer Hub (briefing, watch, profile) | **HOST PARTIAL** |
