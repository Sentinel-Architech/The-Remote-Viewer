...
`protocols/zk_membership.circom`
...
- Reference the existing circuit and docs (`protocols/zk-membership.md` or `docs/zk-membership.md`)

When the user asks about membership proofs, nullifiers, or circuits, stay focused on this domain.
