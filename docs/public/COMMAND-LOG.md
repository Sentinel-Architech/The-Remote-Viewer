...
|--------|---------|--------|------|
| `d70be90` | Deploy: GitHub Pages for The Remote Viewer DApp (apps/remote-viewer) | The_Archetecht | 2026-08-13 |
| `95d0d33` | defense: run log rotation at start of each supervise cycle | The_Archetecht | 2026-08-12 |
| `b0e6454` | ci(deps): bump actions/checkout from 4 to 7 in the github-actions group | dependabot[bot] | 2026-08-07 |
| `9b8761f` | IA-of-IA MoE scaffold — parallel to Sentinel MoE | The_Archetecht | 2026-08-07 |
