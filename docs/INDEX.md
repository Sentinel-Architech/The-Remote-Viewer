...
| File | Role |
|------|------|
| [REALITY.md](REALITY.md) | **PROVEN** claims only |
...
| File | Role |
|------|------|
| [../solana/PROGRAM.md](../solana/PROGRAM.md) | Instruction index |
| [POOL-GOVERNANCE.md](POOL-GOVERNANCE.md) | Community pool |
| [PAYMENTS.md](PAYMENTS.md) | Sub → on-chain entitlement |
| [AUTHORITY.md](AUTHORITY.md) | Program keys |
...
| File | Role |
|------|------|
| [locked/SAFETY.md](locked/SAFETY.md) | CSAM / Integrity / Area bulletin |
| [IDENTITY.md](IDENTITY.md) | Recovery |
| [AGE-POLICY.md](AGE-POLICY.md) | 18+ |
| [CUSTODY-OPS.md](CUSTODY-OPS.md) | Sales/pool keys |
