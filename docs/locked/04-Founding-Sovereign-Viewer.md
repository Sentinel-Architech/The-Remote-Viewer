...
- **Identity Layer** — The status is attested through the sovereign identity system and can be proven without revealing unnecessary personal data.
- **Vault & Destroy Rule** — The status does not survive a confirmed burn. A Viewer who destroys their identity path loses Founding Sovereign recognition along with everything else.
- **Membership Benefits** — The lifetime highest tier and the 2.50% shop discount are specific to this status and are documented alongside the broader American citizen discount.
