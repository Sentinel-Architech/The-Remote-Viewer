...
**Public TRV_POOL revised:** 2026-08-31 — X Money [@TRV_Architech](https://x.com/TRV_Architech)  
...
1. Accepts user payment on the public rail (**X Money @TRV_Architech**) or the legacy SOL path.
...
| Asset | Role | Notes |
|-------|------|--------|
| **X Money** | Public TRV_POOL rail | Handle `@TRV_Architech` |
...
|------|---------|---------|---------|
| **TRV_POOL (public)** | `@TRV_Architech` (X Money) | Originator | Yes |
...
| **Community Pool / TRV_POOL** | **50%** | Public: `@TRV_Architech`. Legacy SOL sink only when the old dual-transfer path runs. |
...
100 % to TRV_POOL (`@TRV_Architech`). Not subject to the creator share.
...
“TRV_POOL is @TRV_Architech on X Money. 50 % creator / 50 % pool. Credits granted only after confirmed payment. Zero simulation.”
